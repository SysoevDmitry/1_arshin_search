...
|------|----------|
| `AGENTS.md` | Инструкция для AI-агентов |
| `Konsol_Excel/KONSOL_APP.md` | Документация консольной версии (v6.2) |
...
| `Docs/Аршин интерфейсы v.2.2.md` | Описание интерфейсов API |
...
1. Проверьте логи в папке `logs/` (GUI) и `Konsol_Excel/Logs/` (консоль)
2. Проверьте доступность API: `curl https://fgis.gost.ru/fundmetrology/eapi/vri`
3. Изучите документацию в `Docs/`, `Konsol_Excel/` и `AGENTS.md`

---

## 📖 ПОМОЩЬ

**Полная документация:** `AGENTS.md`, `Konsol_Excel/KONSOL_APP.md`, `Konsol_Excel/README.md`

**Быстрые ссылки:**
- [Консольная версия](Konsol_Excel/KONSOL_APP.md)
- [AGENTS.md](AGENTS.md)
- [Презентация](Docs/ПРЕЗЕНТАЦИЯ.md)
- [API интерфейсы](Docs/Аршин%20интерфейсы%20v.2.2.md)
